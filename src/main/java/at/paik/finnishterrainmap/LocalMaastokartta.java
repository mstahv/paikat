...
public class LocalMaastokartta extends MapLibre {
    ...
    public static BaseMapConfigurer CONFIG = new BaseMapConfigurer() {
        @Override
        public void configure(MapLibre map) {
            map.initStyle(new LocalMapDef().str());
            // TODO refactor the remaining into LocalMapDef, only static stuff there...
            map.setCenter(22.25, 60.17);
            map.setZoomLevel(12);
            map.addSource("mtk", new VectorMapSource("https://fvtns.dokku1.parttio.org/services/mtk-combined"));
            ...
            map.addSource("kk20", new VectorMapSource("https://fvtns.dokku1.parttio.org/services/korkeuskayra20"));
            map.addSource("kk100", new VectorMapSource("https://fvtns.dokku1.parttio.org/services/korkeuskayra100"));
            map.addSprite("meri", "https://virit.in/maastokartta/merisprite");

            smallZoomLevelsSpecialRules(map);
            // sea
            map.addSourceLayer(new WaterArea("vesi-all"));
            // lakes & ponds
            map.addSourceLayer(new Vesikuoppa());
            // rivers & streams
            map.addSourceLayer(new WaterArea("allas"));

            basicTerrainMapAreasFromMMLStyles(map);

            map.addSourceLayer(new WaterEdge());
            map.addSourceLayer(new WaterEdge() {{
                setId("allasreuna");
                setSourceLayer("rakennusreunaviiva");
                setFilter(new Equals("kohdeluokka", Kohdeluokka.ALLAS___ALUE));
            }});
            map.addSourceLayer(new UnclearWaterEdge());


            // TODO "korkeusmalli" for smallest zoom levels 🤔

            map.addSourceLayer(new LineLayerDefinition("kk100") {{
                setSource("kk100");
            ...
            map.addSourceLayer(new LineLayerDefinition("kk20") {{
                setSource("kk20");
            ...
            // TODO refactor thse
            // TODO viettoviiva
            map.addSourceLayer(new LineLayerDefinition("korkeuskayra") {{
                setSource("mtk");
         ...
         */
            ...
            map.addSourceLayer(new LineLayerDefinition("vesikivikko") {{
                setSource("mtk");
...
//        });
    ...
    static void smallZoomLevelsSpecialRules(MapLibre map) {
        map.addSourceLayer(new WaterArea("vesi"+OVERALL_POSTFIX) {{
        ...
        map.addSourceLayer(new BasicFill("maatalousmaa"+OVERALL_POSTFIX, "#FFD980") {{
            setMaxZoom(OVERALL_BREAKPOINT);
        }});

        map.addSourceLayer(new BasicFill("taajaanrakennettualue"+OVERALL_POSTFIX, "#b2977e") {{
            setMaxZoom(OVERALL_BREAKPOINT);
        }});

        map.addSourceLayer(new Tie1A1BReuna() {{
            setId("tieviiva-numeroidut-1r");
            setSourceLayer("tieviiva-numeroidut"+OVERALL_POSTFIX);
            setMinZoom(0);
            setMaxZoom(ROAD_OVERALL_BREAKPOINT);
        }});
        map.addSourceLayer(new Tie2A2BReuna() {{
            setId("tieviiva-numeroidut-2r");
            setSourceLayer("tieviiva-numeroidut"+OVERALL_POSTFIX);
            setMinZoom(6);
            setMaxZoom(ROAD_OVERALL_BREAKPOINT-1);
        }});
        map.addSourceLayer(new Tie3A3BReuna() {{
        ...
        map.addSourceLayer(new Tie1A1BFill() {{
            setId("tieviiva-numeroidut-1f");
            setSourceLayer("tieviiva-numeroidut"+OVERALL_POSTFIX);
            setMinZoom(0);
            setMaxZoom(ROAD_OVERALL_BREAKPOINT);
        }});
        map.addSourceLayer(new Tie2A2BFill(){{
            setId("tieviiva-numeroidut-2f");
            setSourceLayer("tieviiva-numeroidut"+OVERALL_POSTFIX);
            setMinZoom(6);
            setMaxZoom(ROAD_OVERALL_BREAKPOINT);
        }});
        map.addSourceLayer(new Tie3A3BFill(){{
        ...
        map.addSourceLayer(new BasicLine("valtakunnanraja"+OVERALL_POSTFIX, "#4D00B3") {{getPaint().setLineWidth(3.0);}});
    }

    static void basicTerrainMapAreasFromMMLStyles(MapLibre map) {
        /*
      ...
      "paint": {
         ...
         */
        // suo
        map.addSourceLayer(new BasicFill("soistuma", "#E6F4F5"));
        map.addSourceLayer(new Marsh());
        map.addSourceLayer(new MarshOpen());
        map.addSourceLayer(new OtherOpenArea());
        map.addSourceLayer(new BasicFill("taytemaa", "#E8D9A5"));
      ...
      "paint": {
        ...
        map.addSourceLayer(new BasicFill("taajaanrakennettualue", "#b2977e") {{
            setMaxZoom(12);
        }});
        map.addSourceLayer(new Maatalousmaa());
        map.addSourceLayer(new BasicFill("puisto", "#FDF27C"));
        map.addSourceLayer(new BasicFill("urheilujavirkistysalue", "#d4efb3"));
        map.addSourceLayer(new BasicFill("hietikko", "#e8e8b0"));
        map.addSourceLayer(new BasicFill("louhos", "#dde5dd"));
        map.addSourceLayer(new BasicFill("kallioalue", "#c6c6c6"));


        map.addSourceLayer(new MaastokuvionReuna());

        map.addSourceLayer(new AirportArea());
      ...
      "paint": {
        ...
        map.addSourceLayer(new Ditch());

        map.addSourceLayer(new ErityisalueenReuna());

        // TIET JA RAUTATIET

        // TODO tiet & rautatiet pinnan alla

        map.addSourceLayer(new Ajotie() {{
            setSourceLayer("tieviiva-muut");
        }});
        map.addSourceLayer(new Ajopolku() {{
            setSourceLayer("tieviiva-muut");
        }});
        ...
        map.addSourceLayer(new Tie1A1BReuna());
        map.addSourceLayer(new Tie2A2BReuna());
        map.addSourceLayer(new Tie2ReunaNumeroimaton());
        map.addSourceLayer(new Tie3A3BReuna());
        map.addSourceLayer(new Tie3ReunaNumeroimaton());

        map.addSourceLayer(new Tie1A1BFill());
        map.addSourceLayer(new Tie2A2BFill());
        map.addSourceLayer(new Tie2Numeroimaton());
        map.addSourceLayer(new Tie3A3BFill());
        map.addSourceLayer(new Tie3Numeroimaton());


        map.addSourceLayer(new Building());

        // TODO line & fill rakennus, laiturit yms


        map.addSourceLayer(new SuurjanniteLinja());
        map.addSourceLayer(new CircleLayerDefinition() {{
            setSource("mtk");
        ...
        map.addSourceLayer(new SymbolLayerDefinition() {{
            setSource("mtk");
...
//        addSourceLayer(new MaankayttoReuna()); // kaikki, poista!!
        ...
        map.addSourceLayer(new Parkkipaikka());

        //addSourceLayer(new Vesikulkuvayla());
        //addSourceLayer(new VesikulkuvaylaTahtayslinja());

        map.addSourceLayer(new Kivi());
        map.addSourceLayer(new BasicLine("jyrkanne", "#444") {{
            getPaint().setLineWidth(RoadWidthConstants.ROAD_WIDTH_S);
            setMinZoom(13);
        }});
        map.addSourceLayer(new BasicLine("pistolaituriviiva", "#000") {{
            getPaint().setLineWidth(RoadWidthConstants.ROAD_WIDTH_S);
            setMinZoom(13);
        }});
